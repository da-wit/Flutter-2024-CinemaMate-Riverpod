...
abstract class Initial implements WatchlistState {
...
abstract class Loading implements WatchlistState {
...
class _$UnlikeSuccessImpl implements UnlikeSuccess {
...
abstract class UnlikeSuccess implements WatchlistState {
  const factory UnlikeSuccess() = _$UnlikeSuccessImpl;
}
...
abstract class RemoveSuccess implements WatchlistState {
  const factory RemoveSuccess() = _$RemoveSuccessImpl;
}
...
abstract class LoadSuccess implements WatchlistState {
  const factory LoadSuccess(final List<WatchlistMovie> watchlistMovies) =
      _$LoadSuccessImpl;
