...
part of 'cinema_movies_watcher_state.dart';
...
abstract class Initial implements CinemaMoviesWatcherState {
...
abstract class Loading implements CinemaMoviesWatcherState {
...
abstract class LoadSuccess implements CinemaMoviesWatcherState {
  const factory LoadSuccess(final List<UserMovieInfo> cinemaMovies) =
      _$LoadSuccessImpl;
...
abstract class LoadFailure implements CinemaMoviesWatcherState {
