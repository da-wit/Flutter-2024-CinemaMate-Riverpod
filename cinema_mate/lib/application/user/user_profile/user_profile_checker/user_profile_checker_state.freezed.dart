...
part of 'user_profile_checker_state.dart';
...
abstract class Initial implements UserProfileCheckerState {
...
abstract class Loading implements UserProfileCheckerState {
...
abstract class LoadFailure implements UserProfileCheckerState {
  const factory LoadFailure(final UserProfileFailure failure) =
      _$LoadFailureImpl;
...
abstract class LoadSuccess implements UserProfileCheckerState {
  const factory LoadSuccess(final User userProfile) = _$LoadSuccessImpl;
