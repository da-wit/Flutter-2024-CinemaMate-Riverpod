...
part of 'cinema_profile_checker_state.dart';
...
mixin _$CinemaProfileCheckerState {
  ...
  TResult map<TResult extends Object?>({
    ...
    required TResult Function(HasImage value) hasImage,
    required TResult Function(DoesNotHaveImage value) doesNotHaveImage,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
  TResult? mapOrNull<TResult extends Object?>({
    ...
    TResult? Function(HasImage value)? hasImage,
    TResult? Function(DoesNotHaveImage value)? doesNotHaveImage,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
...
abstract class Initial implements CinemaProfileCheckerState {
...
abstract class Loading implements CinemaProfileCheckerState {
...
abstract class LoadFailure implements CinemaProfileCheckerState {
  const factory LoadFailure(final CinemaProfileFailure failure) =
      _$LoadFailureImpl;
...
abstract class LoadSuccess implements CinemaProfileCheckerState {
  const factory LoadSuccess(final CinemaInfo cinemaProfile) = _$LoadSuccessImpl;
...
class _$HasImageImpl implements HasImage {
...
abstract class HasImage implements CinemaProfileCheckerState {
  const factory HasImage() = _$HasImageImpl;
}
...
class _$DoesNotHaveImageImpl implements DoesNotHaveImage {
...
abstract class DoesNotHaveImage implements CinemaProfileCheckerState {
  const factory DoesNotHaveImage() = _$DoesNotHaveImageImpl;
}
