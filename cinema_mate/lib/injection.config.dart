...
import 'package:cinema_mate/application/account_management/manage_user_account_notifier.dart'
    as _i12;
import 'package:cinema_mate/application/register_form/register_form_norifier.dart'
    as _i9;
import 'package:cinema_mate/application/sign_in_form/sign_in_form_notifier.dart'
    as _i10;
import 'package:cinema_mate/application/user_auth_notifier.dart' as _i11;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i9.RegisterFormNorifier>(
        () => _i9.RegisterFormNorifier(gh<_i7.IAuthRepository>()));
    gh.factory<_i10.SignInFormNotifier>(
        () => _i10.SignInFormNotifier(gh<_i7.IAuthRepository>()));
    gh.factory<_i11.UserAuthNotifier>(
        () => _i11.UserAuthNotifier(gh<_i7.IAuthRepository>()));
    gh.factory<_i12.ManageUserAccountNotifier>(
        () => _i12.ManageUserAccountNotifier(gh<_i7.IAuthRepository>()));
    return this;
  }
}
